...
func TestCacheService_Create(t *testing.T) {
	...
	newCache := repository.Cache{Kye: "test-key", Value: "test-value"}
...
func TestCacheService_Update(t *testing.T) {
	...
	changedCache := repository.Cache{Kye: "test-key", Value: "test-value2"}
...
func TestCacheService_GetAll(t *testing.T) {
	...
	firstCache := repository.Cache{Kye: "test-key1", Value: "test-value1"}
	secondCache := repository.Cache{Kye: "test-key2", Value: "test-value2"}
